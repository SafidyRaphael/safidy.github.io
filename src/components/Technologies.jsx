...
const Technologies = () => {
  return (
    <div className='border-b  border-neutral-800 pb-24'>
      ...
      className='my-20 text-center text-4xl'>Mes Technologies</motion.h2>
      <motion.div
      ...
      className="flex flex-wrap items-center justify-center gap-4">
        ...
        animate="animate"
        className="rounded-2xl border-4 border-neutral-800 p-4">
        <FaServer className='text-7xl text-gray-600'></FaServer>
        </motion.div>
        <motion.div 
        ...
        animate="animate"
        className="rounded-2xl border-4 border-neutral-800 p-4">
            <SiFlutter className=' text-7xl text-[#42A5F5]'></SiFlutter>
        </motion.div>
        <motion.div 
        ...
        animate="animate"
        className="rounded-2xl border-4 border-neutral-800 p-4">
        <DiPython className='text-7xl text-[#e4fc2e]'></DiPython>
        </motion.div>
      </motion.div>
    </div>
  )
